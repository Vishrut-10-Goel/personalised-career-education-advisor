...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!profileRes.ok) throw new Error(profileData.error || "Login failed.");
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-8 fade-in">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-500 font-bold uppercase tracking-widest text-[10px]">Ready to pick up the hustle?</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="vibe-card p-8 space-y-6">
            ...
            <div className="text-center pt-4 border-t border-white/5 text-sm font-bold">
